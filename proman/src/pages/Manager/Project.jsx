...
import { Container, Row, Col, Card, Button, Modal, Form, InputGroup, Badge, ProgressBar, Table, Dropdown, ButtonGroup } from "react-bootstrap";
          ...
          <Col xs={12} md={9} lg={10}>
            ...
            <Row className="g-3 align-items-center mb-2">
              <Col xs={12} md={6}>
                ...
                <div className="text-muted small">Manage and track all projects in one place</div>
              </Col>
              ...
              <Col sm={6} lg={3}>
                <Card className="h-100">
                  <Card.Body>
                    ...
                    <h4 className="mb-0">
                      2<Badge bg="primary" pill className="ms-1">Active</Badge>
                    </h4>
                  </Card.Body>
                </Card>
              </Col>
              <Col sm={6} lg={3}>
                <Card className="h-100">
                  <Card.Body>
                    ...
                    <h4 className="mb-0">
                      4<Badge bg="success" pill className="ms-1">Done</Badge>
                    </h4>
                  </Card.Body>
                </Card>
              </Col>
